...
SCENARIOS = {
    ...
    "C_narrow_passage": {
        ...
        "desc": "窄通道横穿 (8,-3)→(-0.5,-3): 玻璃门+通道A(1.0m), 安全线~14.3m",
        "goal_x": -0.5, "goal_y": -3.0,
        "goal_yaw": 3.14159,  # 到达方向(自东向西): 免终端原地转 180° (~10s,
                               # iter8 C 99s TIMEOUT 主因之一), 更贴近真实使用
        "timeout": 120,  # 14.3m 安全线 + 绕动态行人 + 窄通道减速(vmean~0.2):
                         # 物理时长 85-100s (iter6 74s截断/iter8 99s超时)
    },
    "D_impassable": {
